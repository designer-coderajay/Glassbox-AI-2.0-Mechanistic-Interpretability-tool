...
class NaturalLanguageExplainer:
    ...
    ----------
    language : str
        Report language. Only ``'en'`` is supported in v3.3.0.
        ``'de'``, ``'fr'``, ``'nl'`` are on the v3.4.0 roadmap.
    verbosity : str
    ...
    def __init__(
        ...
        if language != "en":
            raise NotImplementedError("Only language='en' is supported in v3.3.0.")
...
<div style='background:#0F1F3D;border:1px solid #1E3A5F;border-radius:12px;padding:24px;font-family:Inter,-apple-system,sans-serif;'>
  ...
  <p style='color:#3B556B;font-size:0.7rem;margin-top:20px;border-top:1px solid #1E3A5F;padding-top:12px;'>
    Generated by Glassbox AI v3.3.0 · {_ARTICLE_REFS["explainability"]} · {_ARTICLE_REFS["transparency"]}
  </p>
</div>"""
