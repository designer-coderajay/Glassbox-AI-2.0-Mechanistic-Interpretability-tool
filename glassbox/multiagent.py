...
<p style="color:#3B556B;font-size:0.7rem;margin-top:24px;">
  Generated by Glassbox AI v4.2.6 · Multi-Agent Causal Handoff Tracing · Regulation (EU) 2024/1689
</p>
</body>
</html>"""
...
1. SYSTEM COMPOSITION
   {len(calls)}-agent pipeline analysed by Glassbox v4.2.6 Multi-Agent Causal Handoff Tracing.
...
Generated by Glassbox AI v4.2.6 · Regulation (EU) 2024/1689
"""
