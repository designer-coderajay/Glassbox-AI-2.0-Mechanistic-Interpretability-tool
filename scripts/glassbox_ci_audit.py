...
if gh_summary:
    ...
    with open(gh_summary, "a") as f:
        ...
        f.write("---\n")
        f.write("*Generated by [Glassbox AI](https://github.com/designer-coderajay/Glassbox-AI-2.0-Mechanistic-Interpretability-tool)")
        f.write(" v3.6.0 - Regulation (EU) 2024/1689 - AI Act Annex IV*\n")
