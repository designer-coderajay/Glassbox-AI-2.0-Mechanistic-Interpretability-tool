...
- Faithfulness **F1 = 0.704 (Grade B)** — GPT-2 IOI, default circuit, current build, vs. brute-force ablation ground truth. (The full 26-head Wang circuit scores F1 = 0.64.)
